        ...
        <div className="usertable-body" style={{ overflow: 'auto' }}>
            <div className="usertable-body-container">
                <div className="usertable-header" style={{ border: 0 }}>
                    <h4 style={{ marginTop: '15px', marginBottom: '0px' }}>All User-Verified & Unverified</h4>
                    <div className="all-btns res-all-btns">
                        <div className="f-div" style={{ marginLeft: '15px', display: 'flex', alignItems: 'center' }}>
                            <div>

                                <h6 style={{ margin: '0px', fontWeight: '400', color: '#908F8F' }}>Total: <span style={{ color: '#1D1D1D', fontWeight: '400' }}><CountUp end={4000} /></span></h6>
                                <h5 className="res-h5" style={{ marginTop: '10px', fontWeight: '400' }}>
                                    <span style={{ fontWeight: 'bold' }}>All</span> | Verified (<CountUp end={1500} />) | Unverified (<CountUp end={3400} />)
                                </h5>
                            </div>
